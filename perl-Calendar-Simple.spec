...
Source0  : https://cpan.metacpan.org/authors/id/D/DA/DAVECROSS/Calendar-Simple-v2.0.0.tar.gz
...
%prep
%setup -q -n Calendar-Simple-v2.0.0
cd %{_builddir}/Calendar-Simple-v2.0.0
...
%files perl
%defattr(-,root,root,-)
/usr/lib/perl5/vendor_perl/5.30.3/Calendar/Simple.pm
